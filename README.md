...
Привет! Меня зовут Андрей я занимаюсь разработкой на C# по технологии WPF в течении 2-х лет. Реализовал два десктопных приложения для автоматизации бизнес-процессов на моем предыдущем месте работы StaffManager для организации работ с персоналом и SurgeCurentСalculator для снижения уравнительного тока в контактной сети.
